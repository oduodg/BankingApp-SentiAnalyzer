...
Original file is located at
    https://colab.research.google.com/drive/1yFr6YANNAS4_ZFBhh8CoIz67-tPLdR4X

- 한국시티 대신에 다른 은행 데이터 넣어서 점수 산출 저장 가능
- koreanCity_review = pd.read_csv("/content/drive/Shareddrives/언어의미와정보 데이터캡스톤디자인/리뷰 데이터/한국씨티은행/raw/씨티.csv") 이 부분 변경
- csv파일로 저장할 때 이름 변경
...
#csv파일로 저장
view_df.to_csv('한국시티점수계산결과.csv', encoding='utf-8-sig')
view_df.head()
